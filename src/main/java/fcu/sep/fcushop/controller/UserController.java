...
import fcu.sep.fcushop.exception.BadRequestException;
import fcu.sep.fcushop.exception.ResourceNotFoundException;
import fcu.sep.fcushop.service.UserService;
import fcu.sep.fcushop.utill.NewUserFormValidator;
...
public class UserController {
    ...
    public String registerNewUser(@Validated @ModelAttribute("userDto") UserRegistrationDto userDto,
